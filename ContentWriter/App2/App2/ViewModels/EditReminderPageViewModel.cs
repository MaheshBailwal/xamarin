...
//{
//    public class EditReminderPageViewModel : BaseViewModel
//    {
...
//                    //TODO: For demo only
//					remiderService.Remind(DateTime.Now, "Vehicle Service Alert", App.SelectedModel.Name + " is due for service on " + App.SelectedModel.NextServiceDate.ToString("ddd, MMM d, yyyy"));
//            }
//            else
//                return false;
